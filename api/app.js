    ...
    makeid(function(id){
        makeToken(function(token){
            activateToken(function(activeToken){
                con.query("INSERT INTO users VALUES ("+id+",'"+token+"', '"+req.body.email+"','"+req.body.achternaam+"', '', '"+req.body.rekening+"', 1,'"+activeToken+"')", function(err, result, fields){
                    if (err) throw err;
                    // sending email
